...
## ✅ v4.1.2 - ErrorBoundary 測試修復 (2026-01-20) 🆕
...
**修復內容：**
- 修復 `/問題/i` 選擇器匹配多個元素問題，改用 `getByRole('heading')`
- 修復 `rerender` 無法重置 ErrorBoundary 內部狀態問題，使用閉包控制狀態

---

## ✅ v4.1.1 - 排行榜動畫 + 按鈕佈局修復 (2026-01-20)
...
v3.8.x │ PWA 離線支援
v3.9.x │ 訪客互動動畫
v4.0.x │ 測試覆蓋率 + Error Boundary + 動畫優化
v4.1.x │ Bundle 優化 + 排行榜動畫 + UI 修復 ← 目前版本
   ↓
v4.2.x │ 🔮 標籤篩選、深色模式
v4.3.x │ 🔮 即時推播通知、現場表演模式
v5.0.x │ 🔮 統計儀表板、社群登入
```
